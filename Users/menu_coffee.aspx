<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/UserMaster.master" AutoEventWireup="true" CodeFile="menu_coffee.aspx.cs" Inherits="Guest_new" %>
...
<br />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CafeConnectionString %>" SelectCommand="SELECT [name], [image], [price] FROM [menu] WHERE ([type] = @type2)">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="Coffee" Name="type2" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
