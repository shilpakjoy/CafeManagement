<%@ Page Title="" Language="C#" MasterPageFile="~/Guest/UserMaster.master" AutoEventWireup="true" CodeFile="shopping.aspx.cs" Inherits="Guest_shopping" %>
                            ...
                            <asp:DataList ID="DataList1" runat="server" DataKeyField="c_id" DataSourceID="SqlDataSource1" RepeatColumns="3">
                                <ItemTemplate>
                                    ...
                                    <table class="w-100">
                                        ...
                                        <tr>
                                            <td>
     <a href='view_categ_cake.aspx?id=<%# Eval("c_id") %>' class="auto-style2"><b>View More</b></a>&nbsp;
