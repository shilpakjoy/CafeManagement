...
<body>
    ...
    <div>
    <asp:DataList ID="DataList1" runat="server" DataKeyField="cake_id" DataSourceID="SqlDataSource2" BorderColor="#999999" RepeatColumns="3" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
            <ItemTemplate>
